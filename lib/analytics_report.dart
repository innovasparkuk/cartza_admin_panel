          ...
          Expanded(
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  _buildMenuItem(Icons.dashboard, 'Overview', 0),
                  _buildMenuItem(Icons.insert_chart, 'Reports', 1),
                  _buildMenuItem(Icons.analytics, 'Analytics', 2),
                  _buildMenuItem(Icons.monetization_on, 'Sales', 3),
  ...
  Widget _buildSidebarHeader() {
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(bottom: BorderSide(color: Colors.grey.shade200)), // ← Light grey border
      ),
      child: Row(
        children: [
          Container(
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                Text('Analytics Pro', style: TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.bold)), // ← Black text
                Text('Dashboard', style: TextStyle(color: Colors.grey, fontSize: 12)), // ← Grey text
              ],
            ),
          ),
        ],
  ...
  Widget _buildChartsRow() {
    return Row(
      ...
      children: [
        ...
        Expanded(child: _buildTrafficSources()),
      ],
    );
  }
